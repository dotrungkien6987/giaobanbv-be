...
console.log("userID",hoidongID)
  ...
  if (!hoidong) throw new AppError(400, "hoidong not found", "Update  hoidong Error");
...
if(!hoidongUpdate) throw new AppError(400,"hoidongUpdate not found","Update hoidongUpdate error");
if (hoidongUpdate) {
