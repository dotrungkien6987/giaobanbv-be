...
router.get("/files/orphaned", admin.getOrphanedFiles);
router.post("/files/orphaned/delete", admin.deleteOrphanedFiles);
router.get("/files/storage-stats", admin.getStorageStats);
