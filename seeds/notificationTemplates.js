...
const templates = [
...

  {
    ...
    actionUrlTemplate: "/quanlycongviec/yeucau/{{requestId}}",
    icon: "ticket",
...

  {
    ...
    actionUrlTemplate: "/quanlycongviec/yeucau",
    icon: "warning",
    defaultChannels: ["inapp"],
    defaultPriority: "normal",
...

  {
    ...
    defaultChannels: ["inapp", "push"],
    defaultPriority: "normal",
    actionUrlTemplate: "/quanlycongviec/congviec/{{taskId}}",
...

  {
    ...
    defaultChannels: ["inapp", "push"],
    defaultPriority: "normal",
    actionUrlTemplate: "/quanlycongviec/kpi/tu-danh-gia",
...

  {
    ...
    defaultChannels: ["inapp", "push"],
    defaultPriority: "normal",
    actionUrlTemplate: "/quanlycongviec/kpi/ket-qua/{{evaluationId}}",
...

  {
    ...
    defaultChannels: ["inapp", "push"],
    defaultPriority: "urgent",
    actionUrlTemplate: "/quanlycongviec/kpi/chi-tiet/{{evaluationId}}",
...

  {
    ...
    actionUrlTemplate: "/quanlycongviec/kpi/xem/{{evaluationId}}",
    icon: "kpi",
    defaultChannels: ["inapp", "push"],
    defaultPriority: "normal",
