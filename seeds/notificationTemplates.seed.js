...
const templates = [
  ...
  // YÊU CẦU - TẠO MỚI (20)
  {
    ...
    actionUrl: "/quanlycongviec/yeucau/{{_id}}",
    icon: "add_circle",
    priority: "normal",
  },
  ...
  },
  {
    ...
    bodyTemplate: "Yêu cầu được giao cho {{TenNguoiDuocDieuPhoi}}",
    actionUrl: "/quanlycongviec/yeucau/{{_id}}",
    icon: "how_to_reg",
    priority: "low",
  },
  ...
  },
  {
    ...
    recipientConfig: { variables: ["NguoiDuocDieuPhoiID"] },
    titleTemplate: "{{MaYeuCau}} - Nhắc nhở",
    bodyTemplate: "Yêu cầu '{{TieuDe}}' cần tiếp nhận xử lý gấp",
    actionUrl: "/quanlycongviec/yeucau/{{_id}}",
    icon: "notifications_active",
    priority: "high",
  },
  {
    ...
    typeCode: "yeucau-nhac-lai",
    recipientConfig: { variables: ["arrNguoiDieuPhoiID"] },
    titleTemplate: "{{MaYeuCau}} - Nhắc nhở chưa xử lý",
    bodyTemplate: "Yêu cầu '{{TieuDe}}' từ {{TenKhoaGui}} cần được xử lý gấp",
    actionUrl: "/quanlycongviec/yeucau/{{_id}}",
    icon: "notifications_active",
    priority: "high",
  },
