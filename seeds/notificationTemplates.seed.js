...
const templates = [
  ...
  },
  {
    ...
    titleTemplate: "{{MaCongViec}} - {{TieuDe}}",
    bodyTemplate: "Bạn được thêm vào công việc từ {{TenNguoiGiao}}",
    actionUrl: "/quan-ly-cong-viec/{{_id}}",
    icon: "group_add",
    priority: "normal",
  },
  ...
  // CÔNG VIỆC - HỦY GIAO (2)
  {
    ...
    bodyTemplate: "Công việc '{{TieuDe}}' đã bị hủy bởi {{TenNguoiGiao}}",
    actionUrl: "/quan-ly-cong-viec/{{_id}}",
    icon: "cancel",
    priority: "normal",
  },
  ...
  // CÔNG VIỆC - TIẾP NHẬN (4)
  {
    ...
    bodyTemplate: "{{TenNguoiChinh}} đã tiếp nhận công việc '{{TieuDe}}'",
    actionUrl: "/quan-ly-cong-viec/{{_id}}",
    icon: "check_circle",
    priority: "low",
  },
  ...
  // CÔNG VIỆC - HOÀN THÀNH (5)
  {
    ...
    bodyTemplate: "{{TenNguoiChinh}} đã hoàn thành công việc '{{TieuDe}}'",
    actionUrl: "/quan-ly-cong-viec/{{_id}}",
    icon: "task_alt",
    priority: "normal",
  },
  ...
  // CÔNG VIỆC - HOÀN THÀNH TẠM (6)
  {
    ...
    bodyTemplate:
      "{{TenNguoiChinh}} báo hoàn thành '{{TieuDe}}'. Vui lòng duyệt.",
    actionUrl: "/quan-ly-cong-viec/{{_id}}",
    icon: "pending",
    priority: "normal",
  },
  ...
  // CÔNG VIỆC - DUYỆT HOÀN THÀNH (7)
  {
    ...
    bodyTemplate:
      "Công việc '{{TieuDe}}' đã được {{TenNguoiGiao}} duyệt hoàn thành",
    actionUrl: "/quan-ly-cong-viec/{{_id}}",
    icon: "verified",
    priority: "normal",
  },
  ...
  // CÔNG VIỆC - MỞ LẠI (9)
  {
    ...
    bodyTemplate: "Công việc '{{TieuDe}}' được {{TenNguoiGiao}} mở lại",
    actionUrl: "/quan-ly-cong-viec/{{_id}}",
    icon: "restore",
    priority: "high",
  },
  ...
  },
  {
    ...
    bodyTemplate: "Người chính đổi sang {{TenNguoiChinh}}",
    actionUrl: "/quan-ly-cong-viec/{{_id}}",
    icon: "swap_horiz",
    priority: "normal",
  },
  ...
  // CÔNG VIỆC - DEADLINE QUÁ HẠN (45)
  {
    ...
    bodyTemplate: "Công việc '{{TieuDe}}' đã quá deadline: {{Deadline}}",
    actionUrl: "/quan-ly-cong-viec/{{_id}}",
    icon: "warning",
    priority: "urgent",
  },
  ...
  // KPI - TẠO ĐÁNH GIÁ (37)
  {
    ...
    actionUrl: "/quan-ly-kpi/danh-gia/{{_id}}",
    icon: "assessment",
    priority: "normal",
  },
  ...
  // KPI - DUYỆT ĐÁNH GIÁ (38)
  {
    ...
    bodyTemplate:
      "KPI của bạn đã được {{TenNguoiDanhGia}} duyệt. Tổng điểm: {{TongDiemKPI}}",
    actionUrl: "/quan-ly-kpi/danh-gia/{{_id}}",
    icon: "verified",
    priority: "normal",
  },
  ...
  // KPI - DUYỆT TIÊU CHÍ (39)
  {
    ...
    recipientConfig: { variables: ["NhanVienID"] },
    titleTemplate: "KPI - Tiêu chí {{TenTieuChi}} đã duyệt",
    bodyTemplate: "{{TenNguoiDanhGia}} đã duyệt tiêu chí {{TenTieuChi}}",
    actionUrl: "/quan-ly-kpi/danh-gia/{{_id}}",
    icon: "rule",
    priority: "low",
  },
  ...
  // KPI - HỦY DUYỆT (40)
  {
    ...
    bodyTemplate: "KPI bị hủy duyệt. Lý do: {{LyDoHuyDuyet}}",
    actionUrl: "/quan-ly-kpi/danh-gia/{{_id}}",
    icon: "undo",
    priority: "high",
  },
  ...
  // KPI - CẬP NHẬT ĐIỂM QL (41)
  {
    ...
    bodyTemplate:
      "{{TenNguoiDanhGia}} cập nhật điểm QL cho tiêu chí {{TenTieuChi}}",
    actionUrl: "/quan-ly-kpi/danh-gia/{{_id}}",
    icon: "edit_note",
    priority: "normal",
  },
  ...
  // KPI - TỰ ĐÁNH GIÁ (42)
  {
    ...
    titleTemplate: "KPI {{TenChuKy}} - {{TenNhanVien}} hoàn thành",
    bodyTemplate: "{{TenNhanVien}} đã hoàn thành tự đánh giá KPI",
    actionUrl: "/quan-ly-kpi/danh-gia/{{_id}}",
    icon: "check_circle",
    priority: "normal",
  },
  ...
  // KPI - PHẢN HỒI (43)
  {
    ...
    bodyTemplate: "{{TenNhanVien}}: {{NoiDungPhanHoi}}",
    actionUrl: "/quan-ly-kpi/danh-gia/{{_id}}",
    icon: "feedback",
    priority: "normal",
  },
